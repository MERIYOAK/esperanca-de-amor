        ...
        <div className="container mx-auto px-4 py-6 sm:py-8">
          <div className="max-w-2xl mx-auto text-center">
            <div className="mb-6 sm:mb-8">
              ...
              <h1 className="text-2xl sm:text-3xl font-bold text-foreground mb-4">Your Wishlist</h1>
        ...
        <main className="container mx-auto px-4 py-6 sm:py-8">
          <div className="max-w-6xl mx-auto">
            <div className="animate-pulse">
              <div className="h-6 sm:h-8 bg-muted rounded w-1/3 mb-6 sm:mb-8"></div>
        ...
        <main className="container mx-auto px-4 py-6 sm:py-8">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center py-12 sm:py-16">
              <Heart className="h-16 w-16 sm:h-24 sm:w-24 text-muted-foreground mx-auto mb-4" />
              ...
              <Button onClick={() => navigate('/shop')} className="text-base sm:text-lg px-6 sm:px-8 py-2 sm:py-3">
            ...
            {wishlistItems.map((item) => (
              <Card key={item.id} className="group hover:shadow-glow transition-all duration-300 hover:-translate-y-2 overflow-hidden">
                <div className="relative overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
                    <div className="absolute bottom-4 left-4 right-4 flex space-x-2">
                      <Button 
                        size="sm" 
                        className="flex-1 bg-background/90 text-foreground hover:bg-background hover:scale-105 transition-all duration-200 text-xs sm:text-sm"
                      ...
                      <Button 
                        size="sm" 
                        className="flex-1 hover:scale-105 transition-all duration-200 text-xs sm:text-sm"
                ...
                <CardContent className="p-4 sm:p-6">
                  ...
                  <h3 className="text-base sm:text-lg font-semibold mb-2 group-hover:text-primary transition-colors duration-200 line-clamp-2">
                    {item.product.name}
                  </h3>
                  ...
                  <div className="flex items-center mb-3">
                    ...
                    <span className="ml-2 text-xs sm:text-sm text-muted-foreground">({item.product.rating})</span>
                  </div>
              ...
              <CardContent className="p-4 sm:p-6">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between space-y-2 sm:space-y-0">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-medium text-sm sm:text-base">Wishlist Summary</span>
                  </div>
